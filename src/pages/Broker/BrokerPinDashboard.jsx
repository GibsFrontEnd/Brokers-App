...
const BrokerPinDashboard = () => {
  ...
  useEffect(() => {
    const getUserBrokerId = () => {
      ...
      try {
        ...
        console.warn(
          "No broker ID found in decrypted user data. Available fields:",
          Object.keys(user)
        );
        return "";
      } catch (e) {
  ...
  const loadBrokerClients = async () => {
    ...
    try {
      ...
      if (clientsData.success && Array.isArray(clientsData.data)) {
        ...
        console.warn("No sub agents data found for broker:", clientsData);
        setClients([]);
        setError("No sub agents assigned to your broker account.");
      }
    } catch (clientsError) {
      console.error("Failed to load broker sub agents:", clientsError);
      setClients([]);
      setError("Failed to load sub agents. Please try again.");
    } finally {
  ...
  const handleSharePins = async (e) => {
    ...
    if (!selectedClient || !pinAmount) {
      alert("Please select a sub agent and enter pin amount");
      return;
    }
    ...
    try {
      ...
      alert(`${pinAmountNum} pins shared successfully with sub agent!`);
      ...
      const errorMessage =
        error.message || "Failed to share pins. Please try again.";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">
            Manage your pins and track sharing activities
          </p>
          {brokerId && (
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          Transfer pins to your sub agents for their
                          transactions
                        </p>
                        <button
                          onClick={handleOpenShareModal}
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">
                      {searchTerm
                        ...
                        : "You haven't shared any pins with sub agents yet."}
                    </p>
                  </div>
                ) : (
                    ...
                    <>
                      ...
                      {clients.length === 0 && (
                        <p className="text-xs text-red-500 mt-1">
                          No sub agents available for your broker account.
