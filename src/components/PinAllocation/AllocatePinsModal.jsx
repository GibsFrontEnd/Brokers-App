...
const AllocatePinsModal = ({ onAllocationSuccess }) => {
  ...
  const fetchBrokers = async () => {
    try {
      ...
      const formattedBrokers = Array.isArray(brokersData) ? brokersData.map(broker => ({
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Broker Pin Allocation</h2>
          <p className="text-gray-600 mt-1">
            Allocate pins to brokers (requires administrative approval)
          </p>
        </div>
        <button
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl max-w-2xl w-full shadow-2xl">
            ...
            <div className="flex justify-between items-center p-6 border-b border-gray-200">
              <div>
                <h3 className="text-xl font-bold text-gray-900">Allocate Pins to Broker</h3>
                <p className="text-gray-600 text-sm mt-1">Select a broker and specify pin allocation details</p>
              </div>
              <button
            ...
            <div className="p-6 max-h-[70vh] overflow-y-auto">
              {fetchingBrokers ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 font-medium">Loading brokers...</p>
                </div>
              ) : (
